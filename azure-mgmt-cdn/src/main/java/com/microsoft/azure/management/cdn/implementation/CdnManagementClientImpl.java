...
public class CdnManagementClientImpl extends AzureServiceClient {
    ...
    /** Version of the API to be used with the client request. Current version is 2025-03-01. */
    private String apiVersion;

    /**
     * Gets Version of the API to be used with the client request. Current version is 2025-03-01.
     *
    ...
    public String userAgent() {
        return String.format("%s (%s, %s, auto-generated)", super.userAgent(), "CdnManagementClient", "2025-03-01");
    }
